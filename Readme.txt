...
В данном проекте выбиралась лучшая модель для обучения из DecisionTreeClassifier, KNeighborsClassifier, LogisticRegression, SVM в пайплайне с подбором лучших гиперпараметров.
По итогу выбрана модель SVM с гиперпараметром models__kernel=rbf и со стандартизацией признаков классом StandardScaler по метрике ROC-AUC=0.91